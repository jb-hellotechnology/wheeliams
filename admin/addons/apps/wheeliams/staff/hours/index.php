...
*/
    ...
    include('../../Wheeliams.staffmember.earlyfinish.class.php');
    include('../../Wheeliams.staffmember.earlyfinishes.class.php');
    include('../../Wheeliams.staffmember.bankholiday.class.php');
    include('../../Wheeliams.staffmember.bankholidays.class.php');
    include('../../Wheeliams.staffmember.compassionateday.class.php');
    include('../../Wheeliams.staffmember.compassionatedays.class.php');
    ...
    include('../../modes/staff/hours/index.pre.php');
    ...
    # Display your page
    include('../../modes/staff/hours/index.post.php');
